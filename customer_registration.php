...
if (!$FirstName || !$LastName || !$Address || !$City || !$State || !$ZipCode || !$PhoneNumber || !$EmailAddress || !$Username || !$Password) {
...
$query = "insert into customers values
            ('','".$FirstName."','".$LastName."' , '".$Address."', '".$City."',
             '".$State."', '".$ZipCode."', '".$PhoneNumber."', '".$EmailAddress."','".$Username."','".$Password."')";
			 
$result = $conn->query($query);
	
if ($result) {
      echo  " You have been registered successfully.<br />";
		echo "<br />Please click the below link to login";
	  
} else {
  	  echo "An error has occurred.  You could not be registered.";
}
