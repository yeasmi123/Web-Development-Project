...
<div id="wrapper"><!-- #wrapper -->
	...
	<section id="main"><!-- #main content and sidebar area -->
			<section id="content"><!-- #content -->
        		...
        		<article>
        			<h1><a href="#"></a></h1>
					<p> Welcome to the Customer Registration form! </p>
					<form action="customer_registration.php" method="post">
					<table border="0">
						<tr>
							<td>First Name:</td>
								<td><input type="text" name="FirstName" size="16" maxlength="16" /></td>
							</tr>
						<tr>
							<td>Last Name:</td>
								<td><input type="text" name="LastName"  size="16" maxlength="16" /></td>
							</tr>
						<tr>
							<td>Address:</td>
								<td><input type="text" name="Address"  size="16" maxlength="50" /></td>
							</tr>
						<tr>
							<td>City:</td>
